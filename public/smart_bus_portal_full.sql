-- ==========================================
-- SMART BUS PORTAL - FULL DATABASE EXPORT
-- Run this script on your new PC to set up the complete database
-- ==========================================
...
-- 3. Create Buses Table (Complete Schema)
...
-- 4. Create Attendance Table (With detailed status)
CREATE TABLE IF NOT EXISTS attendance (
    id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    bus_id INT(6) UNSIGNED,
    attendance_date DATE NOT NULL,
    status ENUM('Present', 'Absent') DEFAULT 'Present',
    detailed_status VARCHAR(50) DEFAULT 'Scheduled',
...
-- 5. Insert All 38 District Administrators
